...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: "L'adresse ne peut pas être vide." }),
...
__decorate([
    ...
    (0, class_validator_1.IsPhoneNumber)('FR', { message: 'Le numéro de téléphone doit être valide.' }),
    __metadata("design:type", String)
