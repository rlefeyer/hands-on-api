...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Retrieves a list of all menus. **Deprecated: Use v2/menus instead.**',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Retrieves details of a specific menu. **Deprecated: Use v2/menus/:id instead.**',
    }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Menu ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Updates details of an existing menu. **Deprecated: Use v2/menus/:id instead.**',
    }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Menu ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Deletes an existing menu. **Deprecated: Use v2/menus/:id instead.**',
    }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Menu ID' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
...
exports.MenusController = MenusController = __decorate([
    ...
    (0, common_1.Controller)('v1/menus'),
